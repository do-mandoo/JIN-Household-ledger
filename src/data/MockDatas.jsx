...
export const addSavings = newData => {
  savingsData.savings.push(newData);
  console.log(savingsData.savings, 'savings데이터를 보자~');
};

export const deleteSavings = id => {
  savingsData.savings = savingsData.savings.filter(item => item.id !== id);
};

export const updateSavings = (id, updatedData) => {
  savingsData.savings = savingsData.savings.map(item =>
